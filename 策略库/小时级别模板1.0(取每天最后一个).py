...
def PCR(target_assets,paths,window_1=10,window_2=60):
    #信号结果字典
    results = {}
    #全数据字典，包含计算指标用于检查
    full_info={}
    ...
    for code in target_assets:
        ...
        # 添加signal列，使用apply函数
        hourly_data['signal'] = hourly_data['diff'].apply(lambda x: 1 if x > 0 else -1)
...
# 定义参数网格
parameter_grid = {
    'window_1': range(10, 30,5),
    'window_2':range(50,70,5),
}
