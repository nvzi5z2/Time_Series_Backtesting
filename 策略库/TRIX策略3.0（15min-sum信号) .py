...
def TRIX_M(target_assets, paths,window_1=140,window_2=140):
    #信号结果字典
    results = {}
    #全数据字典，包含计算指标用于检查
    full_info={}
    ...
    for code in target_assets:
        ...
        min_data["var_1"] = (TRIPLE_EMA - TRIPLE_EMA.shift(1)) / TRIPLE_EMA.shift(1)
        min_data["var_2"] = min_data["var_1"].ewm(window_2, adjust=False).mean()
...
# 定义参数网格
parameter_grid = {
    'window_1': range(100, 180,10),
    'window_2': range(100, 280,10)
}
