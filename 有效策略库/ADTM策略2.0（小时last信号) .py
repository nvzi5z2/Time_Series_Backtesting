...
def ADTM_H(target_assets, paths,window_1=94,window_2=1):
    #信号结果字典
    results = {}
    #全数据字典，包含计算指标用于检查
    full_info={}
...
# 策略类，包含调试信息和导出方法
class ADTM_H_Strategy(bt.Strategy):
    params = (
...
# 生成信号
strategy_results,full_info = ADTM_H(target_assets, paths)


# 获取策略实例
strat = run_backtest(ADTM_H_Strategy,target_assets,strategy_results,10000000,0.0005,0.0005)
...
# 定义参数网格
parameter_grid = {
    'window_1': range(90, 100,1),
    'window_2': range(1, 3, 1)
}

# # 运行参数优化
# results_df = parameter_optimization(
#     parameter_grid=parameter_grid,
#     strategy_function=ADTM_H,
#     strategy_class=ADTM_H_Strategy,
