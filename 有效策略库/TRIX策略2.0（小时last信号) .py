...
def TRIX_H(target_assets, paths,window_1=35,window_2=40):
    #信号结果字典
    results = {}
    #全数据字典，包含计算指标用于检查
    full_info={}
...
# 策略类，包含调试信息和导出方法
class TRIX_H_Strategy(bt.Strategy):
    params = (
...
# 生成信号
strategy_results,full_info = TRIX_H(target_assets, paths)


# 获取策略实例
strat = run_backtest(TRIX_H_Strategy,target_assets,strategy_results,10000000,0.0005,0.0005)
...
#     strategy_function=TRIX_H,
#     strategy_class=TRIX_H_Strategy,
