...
def TII_H(target_assets, paths,window_1=100,window_2=120):
    #信号结果字典
    results = {}
    #全数据字典，包含计算指标用于检查
    full_info={}
...
# 策略类，包含调试信息和导出方法
class TII_H_Strategy(bt.Strategy):
    params = (
...
paths = {
    ...
    'pv_export':r"D:\量化交易构建\Time_Serires_Backtesting\策略净值序列"
}
...
# 生成信号
strategy_results,full_info = TII_H(target_assets, paths)


# 获取策略实例
strat = run_backtest(TII_H_Strategy,target_assets,strategy_results,10000000,0.0005,0.0005)
...
# 定义参数网格
parameter_grid = {
    'window_1': range(70, 170,10),
    'window_2': range(70, 170,10)
}

# 运行参数优化
# results_df = parameter_optimization(
#     parameter_grid=parameter_grid,
#     strategy_function=TII_H,
#     strategy_class=TII_H_Strategy,
